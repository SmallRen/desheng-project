...
public class DateUtils {
    ...
    public static String DATE_FORMAT_ONE = "yyyyMMdd";

    public static String DocumentNumber = "yyyyMMddHHmmss";

    /**
     * 生成18位单据号
     * yyyyMMddHHmmss 加上4位随机数
     *
     * @return yyyyMMddHHmmss
     */
    public static String getDocumentNumber() {
        String datestr = null;
        SimpleDateFormat df = new SimpleDateFormat(DateUtils.DocumentNumber);
        datestr = df.format(new Date()) + (int) ((Math.random() * 9 + 1) * 1000);
        return datestr;
    }
    ...
    public static String getCurrentDate1() {
        String datestr = null;
        SimpleDateFormat df = new SimpleDateFormat(DateUtils.DATE_FORMAT_ONE);
        datestr = df.format(new Date());
        return datestr;
    }
