...
;layui.define("jquery", function (t) {
    ...
    s.prototype.set = function (t) {
        ...
        var e = ".layui-tab-title", l = a(".layui-tab[lay-filter=" + t + "]"), n = l.children(e),
            //修改tab加载
            s = n.children(".layui-tab-bar"), o = a('.layui-body').children(".layui-tab-content"),
            r = '<li lay-id="' + (i.id || "") + '"' + (i.attr ? ' lay-attr="' + i.attr + '"' : "") + ">" + (i.title || "unnaming") + "</li>";
        //console.log('<div class="layui-tab-item">' + (i.content || "") + "</div>")
        ...
        y = "layui-nav-more", h = "layui-anim layui-anim-upbit", f = {
            tabClick: function (t, i, s, o) {
                ...
                var r = s || a(this), i = i || r.parent().children("li").index(r),
                    ...
                    //修改tab加载
                    u = o.bodyElem ? a(o.bodyElem) : a('.layui-body').children(".layui-tab-content").children(".layui-tab-item"),
                ...
                var n = i || a(this).parent(), s = n.index(), o = n.parents(".layui-tab").eq(0),
                    r = a('.layui-body').children(".layui-tab-content").children(".layui-tab-item"), c = o.attr("lay-filter");
